...
<html lang="en">
  <head>
    ...
    <title>Rental Mobil - Rizal Zidni Nasyit</title>
    <!-- Favicon-->
...
if (!isset($_SESSION['username_rizalz'])) {
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="./indexx.php">Selamat datang, <?php echo $_SESSION['username_rizalz']; ?>!</a>
        <button
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">
          Copyright &copy; Rental Mobil - Herdi Muhammad Syaban_2024
        </p>
      </div>
    </footer>
    <!-- Bootstrap core JS-->
